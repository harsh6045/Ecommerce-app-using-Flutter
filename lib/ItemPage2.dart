...
class ItemPage2 extends StatefulWidget {
  ...
  //ItemPage2({required this.index});
  @override
  State<ItemPage2> createState() => _ItemPageState();
}

class _ItemPageState extends State<ItemPage2> {
  bool isAdded = false;
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "Allow customers to checkout with Stripe payment gateway. Available with Subscription payments to Securely save customers’ cards and charge them automatically for their subscriptions.",
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.bold,
                    ),
