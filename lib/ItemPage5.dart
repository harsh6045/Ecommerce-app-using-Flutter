...
class ItemPage5 extends StatefulWidget {
  ...
  //ItemPage5({required this.index});
  @override
  State<ItemPage5> createState() => _ItemPageState();
}

class _ItemPageState extends State<ItemPage5> {
  bool isAdded = false;
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "Customers often wish to personalize a product according to their requirements. The Magento 2 Personalized products extension by Milople allows your buyers to design products like shirts, t-shirts, mugs and many others by adding images, text, cliparts etc. This improves shopping experience & sales.",
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.bold,
                    ),
