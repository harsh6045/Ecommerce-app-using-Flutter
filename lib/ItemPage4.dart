...
class ItemPage4 extends StatefulWidget {
  ...
  //ItemPage4({required this.index});
  @override
  State<ItemPage4> createState() => _ItemPageState();
}

class _ItemPageState extends State<ItemPage4> {
  bool isAdded = false;
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    "A unique Barcode generator allows you to display all your products and their details with Milople’s Magento 2 Barcode Generator extension. Magento 2 Barcode Scanner also allows you to develop a unique QR code for your inventory.",
                    style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.bold,
                    ),
